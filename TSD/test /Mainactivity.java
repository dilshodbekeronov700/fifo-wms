...
public class MainActivity extends AppCompatActivity {
    ...
    // PM84 da ishlatilishi mumkin bo'lgan barcha scanner action lar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvLog.setTextColor(0xFF00FF00); // yashil matn
        tvLog.setBackgroundColor(0xFF000000); // qora fon
    ...
    private void registerScannerReceivers() {
        ...
        // Barcha actionlarni tinglash uchun wildcard
        try {
